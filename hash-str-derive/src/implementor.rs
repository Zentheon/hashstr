...
pub fn impl_hash_str(input: TokenStream) -> TokenStream {
    ...
    for i in 0..2 {
        ...
        expanded.append_all(quote! {
            ...
            /// # Usage
            /// ```rust
            #[doc = concat!("use hash_str::", stringify!(#struct_path), ";")]
            ///
            ...
            hash_str_derive::impl_hash_str_tests!(hasher = #hasher, con = #con, upper = #upper);
        });
    }
