...
use hash_str_derive::{HashStrDigest, HashStrWrapper, impl_hash_str_tests};

#[derive(Clone, Debug, Eq, HashStrWrapper, HashStrDigest)]
#[hash_str(hasher = blake3::Hash, con = U32, hash_name = "Blake3",
    digest = "
...
impl_hash_str_tests!(hasher = Hash, hash_name = "Blake3", con = U32,);
